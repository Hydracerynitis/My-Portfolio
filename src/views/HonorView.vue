...
<template>
    ...
    <paragraph imageName="ssr_example" title="Sensitive SBC Framework" subtitle="Bias Mitigation Without Sensitie Attribute"
        ...
        <p class="mt-3">My research propose a new framework called Sensitive SBC to study bias without identifying the 
            sensitive attributes that partitions the datasets. Sensiive SBC consists of <b>Slice</b>, <b>Box</b>, and 
            <b>Complex</b>, each representing marginalised population within the data space with different levels of specificity.</p>
        ...
        <p class="mt-3"><b>Box</b> is a combination of multiple <b>Slices</b>, aims to describes marginalised populations as 
            conjunctions of mutliple numerical measurements.</p>
        <p class="mt-3"><b>Complex</b> is a combination of multiple <b>Boxes</b> that cover a more complex area within the dataspace.
            It can also be disconnected as illustrated in the left graph.</p>
    </paragraph>
    <paragraph imageName="metabase" title="How to measure bias that we have yet to know?" subtitle="Research Experiement Setup"
        ...
        <p class="ms-4"><b>3.</b> At last, we train machine learning models using meta-features extracted in previous step to make
            ...
            <b>LightGBM</b>, <b>XGBoost</b> and <b>Multi-Layed-Perception</b>. We also tested using ensembles of individual
            models or chaining them one-by-one to enhance their accuracy</p>
    </paragraph>
    <paragraph imageName="honor_result" title="Performance of Meta-Learning Models" subtitle="Research Result">
        <p class="mt-3">Among all meta-learning models we trained, we found that <b>LightGBM</b> is the most accurate and computation-efficient
            model on both classification (is this dataset biased?) and regression (how much biased datasets are) tasks.</p>
