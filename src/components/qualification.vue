            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="timeline">
                        ...
                        <div class="column">
                            <div class="title">
                                <h2>Bachelor of Advanced Science (Honor) in Computer Science</h2>
                            </div>
                            <div class="description">
                                <p>University of Auckland</p>
                                <h6><i class="fas fa-calendar-alt"></i> 2021 - 2024</h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 mt-lg-0 mt-4">
                    ...
                    <div class="timeline">
                        ...
                        <div class="column">
                            ...
                            <div class="description">
                                <p>Calculate Bias Metrics of LLM Responses</p>
                                <h6><i class="fas fa-calendar-alt"></i> 2024 - 2024</h6>
                            </div>
                        </div>
                    </div>
                </div>
